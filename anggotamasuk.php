...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['tambah'])) {
    ...
    $sql = "INSERT INTO anggotamasuk(nama, tanggal_lahir, jenis_kelamin) VALUES ('$nama', '$tanggal_lahir', '$jenis_kelamin')";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['ubah'])) {
    ...
    if (!empty($nama) && !empty($tanggal_lahir) && !empty($jenis_kelamin)) {
        $sql = "UPDATE anggotamasuk SET nama='$nama', tanggal_lahir='$tanggal_lahir', jenis_kelamin='$jenis_kelamin' WHERE id_anggota='$id_anggota'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['hapus'])) {
    ...
    $sql = "DELETE FROM anggotamasuk WHERE id_anggota='$id_anggota'";
...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['edit'])) {
    $edit_id = $_GET['edit'];
    $edit_sql = "SELECT * FROM anggotamasuk WHERE id_anggota='$edit_id'";
...
<head>
    ...
    <title>Data Anggota Masuk</title>
    <style>
        body {
